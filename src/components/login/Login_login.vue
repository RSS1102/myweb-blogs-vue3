  ...
  <div id="login">
    ...
    <div id="login_Box">
      <div id="enlogin" v-bind:class="enlogin_display">
        <el-form ref="form" :model="enlogin" label-width="60px" @submit.native.prevent="enLogin" :rules="rules">
          ...
          <el-form-item>
            <el-button type="primary" @click=" enLogin_fn('form')" class="login_Btn">登陆</el-button>
          </el-form-item>
        </el-form>
      ...
      <div id="wxlogin" v-bind:class="wxlogin_display"></div>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userPwd: [{required: true, message: "请输入正确密码", trigger: 'blur'},],
      },
    }
...
.loginMethod_div1 {
  ...
  color: black;
  font-weight: bold;
  background-color: #f1efef; /* Green */
  box-shadow: inset 7px 7px 15px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
}
